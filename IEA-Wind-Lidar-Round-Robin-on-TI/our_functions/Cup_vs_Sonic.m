...
RegressionSubPlot(m,n,1,Sonic_10min.WS_N_mean,Cup_10min.WS_N_mean,false,...
    range_MEAN,'Mean WS_N Sonic [m/s]','Mean WS_N Cup [m/s]','Mean WS North');

RegressionSubPlot(m,n,2,Sonic_10min.WS_S_mean,Cup_10min.WS_S_mean,false,...
    range_MEAN,'Mean WS_S Sonic [m/s]','Mean WS_S Cup [m/s]','Mean WS South');

RegressionSubPlot(m,n,3,Sonic_10min.WD_N_mean,Cup_10min.WD_N_mean,true,...
    range_WD,  'Mean WD_N Sonic [deg]','Mean WD_N Cup [deg]','Mean WD North');

RegressionSubPlot(m,n,4,Sonic_10min.WD_S_mean,Sonic_10min.WD_N_mean,true,...
