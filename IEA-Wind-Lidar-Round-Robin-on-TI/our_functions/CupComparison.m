...
RegressionSubPlot(m,n,1,Cup_10min.WS_N_mean,Cup_10min.WS_S_mean,false,...
    range_MEAN,'Mean WS_N Cup [m/s]','Mean WS_S Cup [m/s]',' Mean WS');

RegressionSubPlot(m,n,2,Cup_10min.WS_N_std,Cup_10min.WS_S_std,false,...
    range_STD, 'Std WS_N Cup [m/s]','Std WS_S Cup [m/s]','Std WS');

RegressionSubPlot(m,n,3,Cup_10min.WS_N_TI,Cup_10min.WS_S_TI,false,...
    range_TI,  'TI_N',  'TI_S',  'TI');

RegressionSubPlot(m,n,4,Cup_10min.WD_N_mean,Cup_10min.WD_S_mean,true,...
